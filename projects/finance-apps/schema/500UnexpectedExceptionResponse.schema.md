...
schema_version: 1.0
source: references/snaptrade-sdk/api.yaml#/components/schemas/500UnexpectedExceptionResponse
owner: reference
created: 2025-08-14
last-updated: 2025-08-14
---

# 500UnexpectedExceptionResponse (Schema)
...
- Domain model: markbot/src/markbot/domain/models.py (500UnexpectedExceptionResponse)
