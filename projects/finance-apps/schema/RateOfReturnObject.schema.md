...
schema_version: 1.0
source: references/snaptrade-sdk/api.yaml#/components/schemas/RateOfReturnObject
owner: reference
created: 2025-08-14
last-updated: 2025-08-14
---

# RateOfReturnObject (Schema)
...
- Domain model: markbot/src/markbot/domain/models.py (RateOfReturnObject)
