...
schema_version: 1.0
source: references/snaptrade-sdk/api.yaml#/components/schemas/402BrokerageAuthDisabledResponse
owner: reference
created: 2025-08-14
last-updated: 2025-08-14
---

# 402BrokerageAuthDisabledResponse (Schema)
...
- Domain model: markbot/src/markbot/domain/models.py (402BrokerageAuthDisabledResponse)
