...
schema_version: 1.0
source: references/snaptrade-sdk/api.yaml#/components/schemas/ManualTradeForm
owner: reference
created: 2025-08-14
last-updated: 2025-08-14
---

# ManualTradeForm (Schema)
...
- Domain model: markbot/src/markbot/domain/models.py (ManualTradeForm)
